...
const ReturnBills = ({ navigation,route }) => {
  const screen='ReturnBills';
  ...
  const add_bill = () => {
    ...
    fetch(Server_url + '/api/pos/Add/rtn', {
      method: 'POST',
      headers: {
      ...
      .then(data => {
        ...
        console.log('check:',data[0].bill_no)
  ...
  const add_bill_item_details = (item_bill_no) => {
    ...
    fetch(Server_url + '/api/pos/add/rtn_bill/detail', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    <View style={{ flex: 1, backgroundColor: 'black' }}>
      ...
      <View style={{
        ...
        borderEndWidth: 1
          ...
          marginLeft: 130, color: 'white' }}>RETURNBILL</Text>

        </View>
      </View>
      <View style={{ marginLeft: 30, marginTop: 10, flexDirection: 'row' }}>
        <Text style={{ color: 'white', fontSize: 20, fontWeight: 'bold' }}>BILL RETURN</Text>
        <View style={{
      ...
      <View style={{ marginLeft: 43, marginTop: 3, flexDirection: 'row' }}>
        ...
        <TextInput placeholder='bill_no' backgroundColor='#202124' color='white'
          textAlign='center' placeholderTextColor={"grey"} keyboardType={'numeric'} 
          maxLength={10}
          onChangeText={value=>{
            //setMessageshow(false)
        ...
        <View style={{ marginLeft: 50, width: '75%' }}>
          ...
          <View style={{
            ...
            {/*<TextInput placeholder='0000' color="white" textAlign='center' placeholderTextColor={"grey"}
              ...
              <Text style={{ width: 100, height: 40, marginLeft: 10,marginTop:25,color:'white' }}>{calTax(total)}</Text>
          </View>
          <View style={{
            marginLeft: 150, width: 60, height: 30, alignItems: 'center'
            , flexDirection: 'row'
      ...
      <View style={{ flexDirection: 'row' }}>
          ...
          <TouchableOpacity onPress={Save_validation}>
            <View style={{
              ...
              borderLeftWidth: 1, borderRightWidth: 1,
              borderEndWidth: 1, alignContent:'center',justifyContent:'center',marginLeft:159
            }}>
...
const styles = StyleSheet.create({tablehead: {
  marginLeft: 15,
  marginTop: 10,
